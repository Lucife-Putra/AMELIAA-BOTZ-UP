...
let handler = async(m, {
	...
	if (!args || !args[0]) return conn.reply(m.chat, `Silahkan masukan pesannya\nContoh Penggunaan: ${usedPrefix + command} ${nomorown} pesan untuknya`, fkontak, fakeyt)
	let ngen = ['|']
...
handler.help = ['menfess3 <628XXXXXXXXXX> <pesan>']
handler.tags = ['menbalas']

handler.command = /^(menfesss3|confess3|menfes3|confes3)$/i
