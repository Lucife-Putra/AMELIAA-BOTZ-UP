...
rows: [
{title: `${emot} All`, rowId: ".listmenu", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ"},
{title: `${emot} All V2`, rowId: ".? all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V2"},
...
{title: `${emot} Bugmenu`, rowId: ".bugmenu", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Mᴇɴᴜ Bug"},
{title: `${emot} Yt Amelia-MD`, rowId: ".zyko-md", description: "My yt Sopport Dong 😭"},
...
title: `⃟⟣⟚⟝ ⟡ LIST MENU ${namebot} ⟡ ⟞⟚⟢⃟`,
rows: [
{title: `🤖 ${emot} List Menu V1`, rowId: ".menulist", description: 'Menampilkan list Menu V1'},
{title: `🤖 ${emot} List Menu V2`, rowId: ".menu6", description: 'Menampilkan list Menu V2'},
{title: `🤖 ${emot} List Menu V3`, rowId: ".mlist", description: 'Menampilkan list Menu V3'},
{title: `🤖 ${emot} List Menu V4`, rowId: ".h1", description: 'Menampilkan list Menu V4'},
{title: `🤖 ${emot} List Menu V5`, rowId: ".m9", description: 'Menampilkan list Menu V5'},
{title: `🤖 ${emot} List Menu V6`, rowId: ".m10", description: 'Menampilkan list Menu V6'},
{title: `🤖 ${emot} List Menu V7`, rowId: ".m11", description: 'Menampilkan list Menu V6'},
{title: `🤖 ${emot} List Menu V8`, rowId: ".m12", description: 'Menampilkan list Menu V8'},
]
}, {
title: `⃟⟣⟚⟝ ⟡ JADIBOT ${namebot} ⟡ ⟞⟚⟢⃟`,
rows: [
{title: `😭 ${emot} JASA JADIBOT`, rowId: ".jadibot2", description: 'Menampilkan list harga jadi bot'},
]
}, {
...
{title: `⟐ BuyPremium ⟐`, rowId: ".uppremium", description: "Menampilkan List Premium Bot Ini"},
]}]
...
"productImage":{
"mimetype": "image/jpeg",
"jpegThumbnail": `${pickRandom(['https://telegra.ph/file/1be321e2942f8045fc846.jpg', 'https://telegra.ph/file/1417bf48fbca4cc353a5e.jpg','https://telegra.ph/file/98c80f1a876df204dbe52.jpg','https://telegra.ph/file/522f2e5131daab17a715b.jpg','https://telegra.ph/file/d24af2a50d5400ddea413.jpg'])}`
},
"title": `${ucapan()}`,
...
let thummb = `${pickRandom(['https://telegra.ph/file/1be321e2942f8045fc846.jpg', 'https://telegra.ph/file/1417bf48fbca4cc353a5e.jpg','https://telegra.ph/file/98c80f1a876df204dbe52.jpg','https://telegra.ph/file/522f2e5131daab17a715b.jpg','https://telegra.ph/file/d24af2a50d5400ddea413.jpg'])}`
